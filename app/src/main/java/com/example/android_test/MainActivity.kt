...
fun Library() {
    Column() {
        ...
        Box(modifier = Modifier.padding(16.dp)) {
            Text(text = "Jetpack Compose tutorial", fontSize = 28.sp)
        }
        Box(
            modifier = Modifier.padding(start = 16.dp, end = 16.dp)) {
            Text(text = "Jetpack Compose is a modern toolkit for building " +
                ...
                ,textAlign = TextAlign.Justify, fontSize =  18.sp
            )
        }
        Box(modifier = Modifier.padding(16.dp)) {
            Text(text = "In this tutorial, you build a simple UI component " +
                    "with declarative functions. You call Compose functions to" +
                    " say what elements you want and the Compose compiler does" +
                    " the rest. Compose is built around Composable functions." +
                    " These functions let you define your app\\'s UI programmatically" +
                    " because they let you describe how it should look and provide" +
                    " data dependencies, rather than focus on the process of the UI\\'s" +
